...
def _to_response(cfg) -> ClientConfigResponse:
    return ClientConfigResponse(
        ...
        meta_token_expires_at=cfg.meta_token_expires_at,
        google_ads_customer_id=cfg.google_ads_customer_id,
        google_ads_token_expires_at=cfg.google_ads_token_expires_at,
        linkedin_ads_account_id=cfg.linkedin_ads_account_id,
        linkedin_token_expires_at=cfg.linkedin_token_expires_at,
        tiktok_ads_advertiser_id=cfg.tiktok_ads_advertiser_id,
        tiktok_token_expires_at=cfg.tiktok_token_expires_at,
        hubspot_pipeline_id=cfg.hubspot_pipeline_id,
        hubspot_closed_won_stage_ids=list(cfg.hubspot_closed_won_stage_ids),
        hubspot_token_expires_at=cfg.hubspot_token_expires_at,
        stripe_account_id=cfg.stripe_account_id,
        stripe_history_start_date=cfg.stripe_history_start_date,
        stripe_token_expires_at=cfg.stripe_token_expires_at,
...
async def create_client(
    ...
    cfg = ClientConfig(
        ...
        meta_token_expires_at=req.meta_token_expires_at,
        google_ads_enabled=req.google_ads_enabled,
        google_ads_customer_id=req.google_ads_customer_id,
        google_ads_token_expires_at=req.google_ads_token_expires_at,
        linkedin_ads_enabled=req.linkedin_ads_enabled,
        linkedin_ads_account_id=req.linkedin_ads_account_id,
        linkedin_token_expires_at=req.linkedin_token_expires_at,
        tiktok_ads_enabled=req.tiktok_ads_enabled,
        tiktok_ads_advertiser_id=req.tiktok_ads_advertiser_id,
        tiktok_token_expires_at=req.tiktok_token_expires_at,
        hubspot_enabled=req.hubspot_enabled,
        hubspot_pipeline_id=req.hubspot_pipeline_id,
        hubspot_closed_won_stage_ids=tuple(req.hubspot_closed_won_stage_ids),
        hubspot_token_expires_at=req.hubspot_token_expires_at,
        stripe_enabled=req.stripe_enabled,
        stripe_account_id=req.stripe_account_id,
        stripe_history_start_date=req.stripe_history_start_date,
        stripe_token_expires_at=req.stripe_token_expires_at,
