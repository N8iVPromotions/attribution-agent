...
PROSPECTS = [
    {
        ...
        "industry": "Med Spa",
        "phone": "480-993-2218",
        "notes": "783 reviews, 4.8★. High-volume laser and injectables practice. Likely running Meta ads for patient acquisition.",
    },
    {
        "id": 2,
        "name": "Dolce Medical Spa",
        "contact": "Owner",
        "email": "info@dolcemedicalspas.com",
        "industry": "Med Spa",
        "phone": "480-470-6737",
        "notes": "562 reviews, 5.0★. Premium med spa open 6 days. High volume, active marketing presence.",
    },
    {
        "id": 3,
        "name": "Dentistry of Old Town Scottsdale",
        "contact": "Dr. Brittain",
        "email": "info@dentistryofoldtownscottsdale.com",
        "industry": "Dental",
        "phone": "480-719-6994",
        "notes": "955 reviews, 4.8★. Highest review count in area. Cosmetic dental = high ticket. Almost certainly running ads.",
    },
    {
        "id": 4,
        "name": "The Perfect Secret Med Spa",
        "contact": "Irena",
        "email": "info@itstheperfectsecret.com",
        "industry": "Med Spa",
        "phone": "480-647-8991",
        "notes": "545 reviews, 5.0★. Owner-operated boutique. Irena personally greets and tours clients. Warm, relationship-driven.",
    },
    {
        "id": 5,
        "name": "Advanced Dentistry",
        "contact": "Dr. Oh",
        "email": "info@advdentistry.com",
        "industry": "Dental",
        "phone": "480-945-4700",
        "notes": "304 reviews, 4.9★. Reviews mention impressive technology. Owner open to new tools.",
    },
    {
        "id": 6,
        "name": "BODI Fitness",
        "contact": "Owner",
        "email": "info@scottsdalebodi.com",
        "industry": "Fitness",
        "phone": "480-444-8062",
        "notes": "177 reviews, 4.8★. Boutique fitness studio. Membership model = LTV attribution is high value.",
    },
    {
        "id": 7,
        "name": "Scottsdale Med Spa",
        "contact": "Melissa",
        "email": "info@scottsdalemedspa.beauty",
        "industry": "Med Spa",
        "phone": "480-454-6959",
        "notes": "143 reviews, 4.9★. Smaller boutique. Each patient matters more — N8iV Intelligence ROI story hits harder.",
    },
    {
        "id": 8,
        "name": "Pvolve Scottsdale Waterfront",
        "contact": "Studio Manager",
        "email": "info@studios.pvolve.com",
        "industry": "Fitness",
        "phone": "480-847-2455",
        "notes": "National franchise. Local vs. network attribution gap is the pitch.",
    },
    {
        "id": 9,
        "name": "Kelly Jones Luxury Real Estate",
        "contact": "Kelly Jones",
        "email": "info@kellyfjones.com",
        "industry": "Real Estate",
        "phone": "480-399-9322",
        "notes": "4.9★. Luxury realtor at Camelback. Real estate + Meta lead gen = textbook N8iV Intelligence use case.",
    },
    {
        "id": 10,
        "name": "Patricia Garrity Luxury Real Estate",
        "contact": "Patricia Garrity",
        "email": "info@patriciagarrityhomes.com",
        "industry": "Real Estate",
        "phone": "602-942-7520",
        "notes": "28 reviews, 5.0★. Reviews mention exceptional marketing of listings. Same N8iV Intelligence pitch as Kelly Jones.",
    },
]

INDUSTRY_ANGLES = {
    "Med Spa": {
        "pain": "cost per closed patient vs. cost per lead",
        "metric": "booked appointments and treatment revenue",
        "angle": "every campaign you run should trace back to a treatment chair — not just a form fill",
    },
    "Dental": {
        "pain": "cost per closed treatment vs. cost per new patient call",
        "metric": "closed treatment revenue by campaign",
        "angle": "a crown case is worth $3,000 — knowing which ad drove that patient changes everything",
    },
    "Fitness": {
        "pain": "cost per retained member vs. cost per trial signup",
        "metric": "membership LTV by acquisition channel",
        "angle": "the campaign that brings members who stay 12 months is worth 10x the campaign that brings 30-day cancellations",
    },
    "Real Estate": {
        "pain": "cost per closed transaction vs. cost per lead",
        "metric": "closed transaction revenue by campaign",
        "angle": "one closed deal can mean $30,000+ in commission — knowing which ad drove it changes every budget decision",
    },
}
...
def send_draft_to_self(
    email: dict, prospect: dict, sender: str, app_password: str
) -> None:
